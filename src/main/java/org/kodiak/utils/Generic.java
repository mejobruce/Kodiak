...
//			Reporter.log("Assertion done on.");
	...
	public static void srcollDownRobotZenefit() throws AWTException, InterruptedException {
		...
		boolean status = Generic.isElementPresnt(driver, "//div[normalize-space()='Quick Links']", 60).isDisplayed();
		...
		Generic.isElementPresnt(driver,"//div[@title='Human Resources']", 120).click();
